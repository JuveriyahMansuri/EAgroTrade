...
class OrderAdmin(admin.ModelAdmin):
    list_display=('order_id','order_date','order_status','payment_id','user_id')
    list_editable=('order_date','order_status')
    list_per_page = 5
    search_fields = ('order_id','order_date','order_status','payment_id','user_id')
    list_filter = ('order_id','user_id',)
